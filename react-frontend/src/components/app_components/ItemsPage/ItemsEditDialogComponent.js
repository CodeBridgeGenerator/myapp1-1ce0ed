...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputTextarea id="details" rows={5} cols={30} value={_entity?.details} onChange={ (e) => setValByKey("details", e.target.value)} autoResize  required  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="qty" className="w-full mb-3 p-inputtext-sm" value={_entity?.qty} onChange={(e) => setValByKey("qty", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
            {!_.isEmpty(error["qty"]) && (
